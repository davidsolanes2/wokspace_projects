        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('autoEscuelaApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-autoEscuelaApp-error');
                                var entityKey = httpResponse.headers('X-autoEscuelaApp-params');
                                if (errorHeader) {
